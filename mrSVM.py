...
class MRsvm(MRJob):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.data = pickle.load(open('D:\学习资源\机器学习\ML\data\Ch15\svmDat27'))
        self.w = 0
        self.eta = 0.69
        self.dataList = []
    ...
    def steps(self):
        return ([MRStep(mapper=self.map,mapper_final=self.map_fin,reducer=self.reduce)]*self.options.iterations)
